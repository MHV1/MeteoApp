...
import com.mhv.meteoapp.data.DatabaseContract.LocationEntry;
import com.mhv.meteoapp.data.DatabaseContract.WeatherEntry;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testProviderRegistry() {
        ...
        // CustomContentProvider class.
        ComponentName componentName = new ComponentName(mContext.getPackageName(),
                CustomContentProvider.class.getName());
        try {
    ...
    */
    public void testGetType() {
        ...
        // vnd.android.cursor.dir/com.mhv.meteoapp/weather
        assertEquals("Error: the WeatherEntry CONTENT_URI should return WeatherEntry.CONTENT_TYPE",
                WeatherEntry.CONTENT_TYPE, type);

        String testLocation = "94074";
        // content://com.mhv.meteoapp/weather/94074
        ...
        // content://com.mhv.meteoapp/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/com.mhv.meteoapp/weather/1419120000
        assertEquals("Error: the WeatherEntry CONTENT_URI with location and date should return WeatherEntry.CONTENT_ITEM_TYPE",
                WeatherEntry.CONTENT_ITEM_TYPE, type);

        // content://com.mhv.meteoapp/location/
        type = mContext.getContentResolver().getType(LocationEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.mhv.meteoapp/location
